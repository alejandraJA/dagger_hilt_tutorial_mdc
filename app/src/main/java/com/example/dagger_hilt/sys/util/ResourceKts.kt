...
data class ResourceKts<out T>(
    ...
    companion object {
        ...
        fun <T> loading(): ResourceKts<T> = ResourceKts(ConstantsKts.StatusResponse.LOADING, null, null)

        fun <T> blank(): ResourceKts<T> = ResourceKts(ConstantsKts.StatusResponse.BLANK, null, null)
    }
}
